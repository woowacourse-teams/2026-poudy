...
class IngredientSearchOrderTest {
    ...
    void ordersChosungSearch() {
        IngredientCatalog ingredients = IngredientCatalog
            .from(List.of(ingredient(10L, "메틸판테놀에스터"), ingredient(20L, "판테놀")));
    ...
    void aliasDoesNotPromoteNameMatch() {
        IngredientCatalog ingredients = IngredientCatalog
            .from(List.of(ingredient(10L, "판테놀"), ingredient(20L, "판테닐에틸에터", "판테닐에터")));
    ...
    void keepsNameMatchBeforeAliasMatch() {
        IngredientCatalog ingredients = IngredientCatalog.from(List.of(ingredient(10L, "판테놀", "판테놀별칭")));
    ...
    void keepsAliasMatch() {
        IngredientCatalog ingredients = IngredientCatalog.from(List.of(ingredient(10L, "백혈구추출물", "류코사이트추출물")));
    ...
    void limitsSearchResult() {
        ...
        assertThat(ingredients.search("판테놀")).hasSize(IngredientCatalog.SEARCH_RESULT_LIMIT);
    }
    ...
    void keepsEveryMatchBelowLimit() {
        IngredientCatalog ingredients = IngredientCatalog
            .from(List.of(ingredient(10L, "판테놀"), ingredient(20L, "다이판테놀")));
