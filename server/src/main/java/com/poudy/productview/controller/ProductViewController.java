...
public class ProductViewController {
    ...
    public ProductViewController(ProductViewService service) {
    ...
    public void recordProductView(@Parameter(example = "101") @PathVariable Long productId) {
        service.record(productId);
    }
}
