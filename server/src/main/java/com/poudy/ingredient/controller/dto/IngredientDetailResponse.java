...
public record IngredientDetailResponse(
    @NotNull @Schema(example = "1012") Long id,
    ...
    @NotNull List<String> groupCodes,
    @NotNull @Schema(description = "이 성분을 포함한 제품 수", example = "175") Long productCount,
    ...
    public static IngredientDetailResponse from(IngredientDetail detail) {
        ...
        return new IngredientDetailResponse(
            ...
            detail.groupCodes().stream().map(ExcludeCode::value).toList(),
            detail.productCount(),
