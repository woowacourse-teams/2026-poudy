...
public class ExcludeCodeController {
    ...
    private final ExcludeCodeService excludeCodeService;

    public ExcludeCodeController(ExcludeCodeService excludeCodeService) {
        this.excludeCodeService = excludeCodeService;
    }
    ...
    public ResponseEntity<ExcludeCodeListResponse> findExcludeCodes() {
        return ResponseEntity.ok(ExcludeCodeListResponse.from(excludeCodeService.findAll()));
    }
}
