...
public record ProductFilterRequest(
        ...
        @UniqueElements @ArraySchema(schema = @Schema(example = "1012"), uniqueItems = true) List<Long> includeIngredientIds,
        @UniqueElements @ArraySchema(schema = @Schema(example = "3551"), uniqueItems = true) List<Long> excludeIngredientIds,
